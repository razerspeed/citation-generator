...
import { BookForm } from "@/components/citation-generator/citation-forms/BookForm";
import { JournalForm } from "@/components/citation-generator/citation-forms/JournalForm";
import { WebpageForm } from "@/components/citation-generator/citation-forms/WebpageForm";
import { CommonFields } from "@/components/citation-generator/citation-forms/CommonFields";
import { toast } from "react-toastify";
import { generateCitationFromText } from "../action";
  ...
  const onFormSubmit = async (data: CitationFormData) => {
    ...
    try {
      ...
      try {
        ...
        let result = await generateCitationFromText({
          data: citationData,
          formData: data,
      ...
      //   router.push(result.redirectUrl); // Should NOT refresh the page
      // }
