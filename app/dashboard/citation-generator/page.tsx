...
import { StyleSearch } from "@/components/citation-generator/StyleSearch";
import { CitationForm } from "@/components/citation-generator/CitationForm";
import { CitationPreview } from "@/components/citation-generator/CitationPreview";
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-1 lg:w-1/2 w-full bg-white rounded-lg border border-gray-100 overflow-hidden">
                ...
                <div className="h-[500px]">
                  <CitationForm onSuccess={loadReferences} />
                </div>
              </div>
